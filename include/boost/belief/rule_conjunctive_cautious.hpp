...
#ifndef BOOST_BELIEF_RULE_CONJUNCTIVE_CAUTIOUS_HPP
#define BOOST_BELIEF_RULE_CONJUNCTIVE_CAUTIOUS_HPP
        ...
        : public rule_base
{
    ...
    mass<FOD, T> operator()(const mass<FOD, T> & m1, const mass<FOD, T> & m2) const
    {
        ...
        for(std::size_t A = 0; A < FOD::powerset_size - 1; ++A) {
            if(test_tools::check_is_small(1 - w_min12[A], aux::tolerance)) {
                continue;
            }
...
#endif // BOOST_BELIEF_RULE_CONJUNCTIVE_CAUTIOUS_HPP
