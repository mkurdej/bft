...
#ifndef BOOST_BELIEF_IMPLICABILITY_HPP
#define BOOST_BELIEF_IMPLICABILITY_HPP
...
public:
    ...
    {
        return ! test_tools::check_is_small(this->m_values.front(), aux::tolerance);
    }
};
...
#endif // BOOST_BELIEF_IMPLICABILITY_HPP
