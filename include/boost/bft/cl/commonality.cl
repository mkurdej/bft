...
///
/// Data structure:
///     0000|AAAA|BBBB|OOOO    <- get_global_size(0) elements of each type in a
///     row
__kernel void mass_to_commonality_1d_soa(__global __write_only float* dQ,
...
///
/// Data structure:
///     0ABO|0ABO|0ABO|0ABO    <- get_global_size(0) elements of each type in a
///     row
__kernel void mass_to_commonality_1d_aos(__global __write_only float* dQ,
                                         __global __read_only const float* dM,
                                         const __read_only uint setSize,
                                         const __read_only ulong count)
{
...
///     0000|AAAA|BBBB|OOOO    <- get_global_size(0) elements of each type in a
///     row
__kernel void commonality_to_mass_1d_soa(__global __write_only float* dM,
...
///     0ABO|0ABO|0ABO|0ABO    <- get_global_size(0) elements of each type in a
///     row
__kernel void commonality_to_mass_1d_aos(__global __write_only float* dM,
                                         __global __read_only const float* dQ,
                                         const __read_only uint setSize,
                                         const __read_only ulong count)
{
