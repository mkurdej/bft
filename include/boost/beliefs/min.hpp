...
#ifndef BOOST_BELIEFS_MIN_HPP
#define BOOST_BELIEFS_MIN_HPP
...
dst_function<FOD, T> (min) BOOST_PREVENT_MACRO_SUBSTITUTION (const dst_function<FOD, T> & f1, const dst_function<FOD, T> & f2)
{
