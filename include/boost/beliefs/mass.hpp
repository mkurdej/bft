...
#ifndef BOOST_BELIEFS_MASS_HPP
#define BOOST_BELIEFS_MASS_HPP
...
public:
    ...
    explicit mass(const dst_function<FOD, T> & f)
    ...
    // beliefs::fuse(rule_conjunctive(), mf1, mf2); // mf1 <- mf1 \opconj mf2
    // mf12 = beliefs::return_fuse(rule_conjunctive(), mf1, mf2); // const // mf12 <- mf1 \opconj mf2
    ...
    bool is_focal() const
    {
        return is_focal(dst_function<FOD, T>::template Idx<>::value);
    }

    template <typename S0>
    bool is_focal() const
    {
        return is_focal(dst_function<FOD, T>::template Idx<S0>::value);
    }

    template <typename S0, typename S1>
    bool is_focal() const
    {
        return is_focal(dst_function<FOD, T>::template Idx<S0,S1>::value);
    }

    template <typename S0, typename S1, typename S2>
    bool is_focal() const
    {
        return is_focal(dst_function<FOD, T>::template Idx<S0,S1,S2>::value);
    }

    template <typename S0, typename S1, typename S2, typename S3>
    bool is_focal() const
    {
        return is_focal(dst_function<FOD, T>::template Idx<S0,S1,S2,S3>::value);
    }

    template <typename S0, typename S1, typename S2, typename S3, typename S4>
    bool is_focal() const
    {
        return is_focal(dst_function<FOD, T>::template Idx<S0,S1,S2,S3,S4>::value);
    }

    template <typename S0, typename S1, typename S2, typename S3, typename S4, typename S5>
    bool is_focal() const
    {
        return is_focal(dst_function<FOD, T>::template Idx<S0,S1,S2,S3,S4,S5>::value);
    }

    template <typename S0, typename S1, typename S2, typename S3, typename S4, typename S5, typename S6>
    bool is_focal() const
    {
        return is_focal(dst_function<FOD, T>::template Idx<S0,S1,S2,S3,S4,S5,S6>::value);
    }

    template <typename S0, typename S1, typename S2, typename S3, typename S4, typename S5, typename S6, typename S7>
    bool is_focal() const
    {
        return is_focal(dst_function<FOD, T>::template Idx<S0,S1,S2,S3,S4,S5,S6,S7>::value);
    }

    template <typename S0, typename S1, typename S2, typename S3, typename S4, typename S5, typename S6, typename S7, typename S8>
    bool is_focal() const
    {
        return is_focal(dst_function<FOD, T>::template Idx<S0,S1,S2,S3,S4,S5,S6,S7,S8>::value);
    }
    ...
    bool is_focal() const
    {
        return is_focal(dst_function<FOD, T>::template Idx<S0,S1,S2,S3,S4,S5,S6,S7,S8,S9>::value);
    }
