...
#ifndef BOOST_BELIEFS_RULE_NORMALIZATION_HPP
#define BOOST_BELIEFS_RULE_NORMALIZATION_HPP

#include <boost/beliefs/mass.hpp>
#include <boost/beliefs/rule_base.hpp>
#include <boost/beliefs/total_conflict_exception.hpp>
...
// throw an exception boost::beliefs::total_conflict_exception
        ...
        : public rule_base
{
    ...
    {
        if (m.is_degenerate()) {
            BOOST_THROW_EXCEPTION(boost::beliefs::total_conflict_exception());
...
#endif // BOOST_BELIEFS_RULE_NORMALIZATION_HPP
